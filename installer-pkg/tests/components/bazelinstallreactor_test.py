...
class BazelInstallReactorTest(unittest.TestCase):
    ...
    def test_install_action_reaction(self):
        ...
        self.assertEqual("brew tap bazelbuild/tap/bazelisk", str(commands[0]))
        self.assertEqual("brew tap-pin bazelbuild/tap/bazelisk", str(commands[1]))
    ...
    def test_upgrade_action_reaction(self):
        ...
        self.assertEqual("brew tap bazelbuild/tap/bazelisk", str(commands[1]))
        self.assertEqual("brew tap-pin bazelbuild/tap/bazelisk", str(commands[2]))
